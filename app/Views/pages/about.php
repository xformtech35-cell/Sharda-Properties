...
<div class="bg-gray-50 min-h-screen pb-16">
    ...
    <div class="relative bg-gradient-to-br from-indigo-950 via-indigo-900 to-indigo-800 text-white py-20 px-4 text-center overflow-hidden hero-section">
        ...
        <div class="relative z-10 max-w-4xl mx-auto space-y-4">
            ...
            <h1 class="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-tight animate-fade-in-up delay-100">About Sharda Properties</h1>
            <div class="w-24 h-1.5 bg-indigo-400 mx-auto mt-4 rounded-full animate-fade-in-up delay-150"></div>
            <p class="mt-4 text-base sm:text-lg md:text-xl text-indigo-100/90 max-w-2xl mx-auto font-light leading-relaxed animate-fade-in-up delay-200">
                Your premium real estate partner helping you find properties that suit your lifestyle and business requirements.
            </p>
        </div>
    </div>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 space-y-16 sm:space-y-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div class="space-y-6 order-2 md:order-1 scroll-reveal-left">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">Building Dreams,<br>Delivering Trust</h2>
                ...
                <div class="flex items-center gap-6 pt-4">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs sm:text-sm font-semibold text-gray-700">1000+ Happy Clients</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="h-2.5 w-2.5 rounded-full bg-indigo-600 animate-pulse"></span>
                        <span class="text-xs sm:text-sm font-semibold text-gray-700">500+ Properties Sold</span>
                    </div>
                </div>
            </div>
            <div class="order-1 md:order-2 relative group scroll-reveal-right">
                <div class="rounded-3xl overflow-hidden shadow-2xl ring-1 ring-gray-200/50 h-72 sm:h-96 bg-gray-200 relative">
                    <img
                ...
                <!-- floating badge -->
                <div class="absolute -bottom-4 -left-2 sm:-left-4 bg-white rounded-2xl shadow-xl px-4 sm:px-5 py-3 border border-gray-100 hidden sm:flex items-center gap-3 card-hover-smooth animate-fade-in-up delay-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div class="group bg-white p-6 sm:p-10 rounded-3xl border border-gray-100 shadow-sm card-hover-smooth scroll-reveal delay-100 space-y-5 relative overflow-hidden">
            ...
            <div class="group bg-white p-6 sm:p-10 rounded-3xl border border-gray-100 shadow-sm card-hover-smooth scroll-reveal delay-200 space-y-5 relative overflow-hidden">
                <div class="absolute -top-10 -right-10 w-32 h-32 bg-indigo-50 rounded-full opacity-50"></div>
                <div class="bg-indigo-50 p-3.5 rounded-2xl inline-block text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white group-hover:scale-110 transition-all duration-300 shadow-xs">
        ...
        <div class="bg-white p-6 sm:p-10 md:p-14 rounded-3xl border border-gray-100 shadow-sm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-10">
                <div class="group text-center space-y-4 p-4 sm:p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300 scroll-reveal delay-100 card-hover-smooth">
                ...
                <div class="group text-center space-y-4 p-4 sm:p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300 scroll-reveal delay-200 card-hover-smooth">
                    <div class="bg-indigo-50 p-4 rounded-2xl inline-block text-indigo-600 mx-auto ring-8 ring-indigo-50/50 group-hover:bg-indigo-600 group-hover:text-white group-hover:scale-110 transition-all duration-300">
                ...
                <div class="group text-center space-y-4 p-4 sm:p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300 scroll-reveal delay-300 card-hover-smooth">
                    <div class="bg-indigo-50 p-4 rounded-2xl inline-block text-indigo-600 mx-auto ring-8 ring-indigo-50/50 group-hover:bg-indigo-600 group-hover:text-white group-hover:scale-110 transition-all duration-300">
        ...
        <section class="bg-indigo-950 text-white py-12 sm:py-16 rounded-3xl relative overflow-hidden shadow-2xl">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 relative z-10">
                ...
                <div class="max-w-4xl mx-auto relative group">
                    <div id="aboutTestimonialSlider" class="overflow-hidden relative rounded-3xl bg-gradient-to-b from-indigo-900/80 to-indigo-900/40 border border-indigo-800/80 p-6 sm:p-12 shadow-2xl backdrop-blur-md min-h-[260px] flex items-center justify-center">
                    ...
                    <button id="aboutSliderPrevBtn" class="absolute -left-2 sm:-left-6 top-1/2 -translate-y-1/2 bg-indigo-900/90 hover:bg-indigo-600 text-white p-2.5 sm:p-3 rounded-full border border-indigo-700 shadow-xl transition-all cursor-pointer z-20">
                        <i data-lucide="chevron-left" class="h-5 w-5"></i>
                    </button>
                    <button id="aboutSliderNextBtn" class="absolute -right-2 sm:-right-6 top-1/2 -translate-y-1/2 bg-indigo-900/90 hover:bg-indigo-600 text-white p-2.5 sm:p-3 rounded-full border border-indigo-700 shadow-xl transition-all cursor-pointer z-20">
